...
<div>
<a href="{{ $actionUrl }}" style="color:red;padding:20px;Background-color:#2d3748; margin-bottom:20px">verfiy</a><br>
</div>

<div style="margin-top:50px">
<span style="margin-top:20px" >Please click the button below to verify your email address.</span>
