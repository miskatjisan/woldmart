...
<div>
<h4 style="margin-top:20px" >This password reset link will expire in :60 minutes.</h4>
<h4 style="margin-top:20px margin-bottom:10px" >Please click the botton below to Forgot your Account.</h4>
<a href="{{ $actionUrl }}" style="color:red;padding:20px;Background-color:#2d3748; margin-bottom:20px">Forgot Password</a><br>
</div>

<div style="margin-top:50px">

<h4 style="margin-top:20px" >Please click the Url below to Forgot your Account.</h4>
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">© 2021 . All rights reserved.</p>
